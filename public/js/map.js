...
$(document).ready(function () {
  ...
  $(".allButtons").click(function(event) {
    var places = event.target.id; 
 
 
   
   
    var lol = `<div class="page-header">
    <h1>Search for a Park</h1></div>
<div id="map"></div>
<div id="panel"></div>`
   $( "#places").html(lol);
 ...
 function geocode(platform) {
    var geocoder = platform.getGeocodingService(),
      geocodingParameters = {
        searchText: places + " " + "Park" + ', chicago, il',
        jsonattributes : 1
      };
  ...
  var platform = new H.service.Platform({
    apikey: 'yDPG5r1pLsqRk3Db4Cf_6hgBeDZMODhLJ1LHn21Bo3A'
  });
